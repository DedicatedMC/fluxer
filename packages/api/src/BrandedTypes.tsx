...
export type TenantID = Brand<bigint, 'TenantID'>;
...
export function createTenantID<T extends bigint>(id: T extends BrandedValue ? never : T): TenantID {
	return brand<T, 'TenantID'>(id);
}
